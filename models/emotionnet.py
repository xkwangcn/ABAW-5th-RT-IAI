...
class EmoNet(nn.Module):
    def __init__(self,n_expression=0):
        super(EmoNet, self).__init__()
        self.feature = FAN_()
        #------wrt------
        # self.feature.fan.load_state_dict(torch.load('./models/2dfan2.pth'))
...
if __name__ == '__main__':
    net = EmoNet()
    # net = torch.load('../models/model_16.pth')
    #net = torch.load('../results/model/VA/20230216-14-39_VA_Face_[0.001_1e-05]/model_101.pth')
    print(net)
